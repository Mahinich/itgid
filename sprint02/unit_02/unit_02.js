...
// ВІДБУЛАСЬ КОНКАТЕНАЦІЯ СТРОКИ ʼ3ʼ ТА ЧИСЛА 5
...
function t9() {
    ...
    document.querySelector('.i-9').value = ''; // получили значение
...
function t12() {
    ...
    let dataSurname = document.querySelector('.i-12-2').value;
    document.querySelector('.out-12').innerHTML = 'Hello ' + dataName + ' ' + dataSurname;
}
...
function t16() {
    let firsdtInput = document.querySelector('.i-16-1').value;
    let secondInput = document.querySelector('.i-16-2').value;
    let output = document.querySelector('.out-16');

    output.innerHTML = firsdtInput + secondInput;
...
function t19() {
    let firstInput = document.querySelector('.i-19-1').value;
    let secondtInput = document.querySelector('.i-19-2').value;

    document.querySelector('.out-19').innerHTML = +firstInput + +secondtInput;
}
