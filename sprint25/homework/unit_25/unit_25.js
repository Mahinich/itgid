...
function f1() {
  ...
  const APIKEY = "a7YIZbL10lRotUHp";
  xhr.setRequestHeader('apikey', APIKEY);

  xhr.onload = () => {
    const receivedData = JSON.parse(xhr.response);

    document.querySelector('.out-1').textContent = receivedData['random-string'];
  }
...
function f2() {
  ...
  xhr.onload = function () {
    ...
    document.querySelector('.out-2').textContent = receivedData['random-string'];
  }
...
function f4() {
  ...
  xhr.onload = () => {
    ...
    document.querySelector('.out-4').textContent = receivedData['random-number'];
  }
...
function f5() {
  ...
  xhr.onload = () => {
    ...
    document.querySelector('.out-5').textContent = receivedData['random-number'];
  }
...
function f6() {
  ...
  xhr.onload = () => {
    ...
    document.querySelector('.out-6-response').textContent = receivedData;
  }
...
function f8() {
  ...
  xhr.onload = () => {
    ...
    document.querySelector('.out-8').textContent = receivedData.itemCount;
  }
...
function f9() {
  ...
  xhr.onload = function () {
    ...
    document.querySelector('.out-9').textContent = receivedData.result.designation;
  }
...
function f10() {
  ...
  xhr.onload = () => {
    ...
    console.log(receivedData);
    document.querySelector('.out-10').textContent = receivedData.result.age;
  }
  xhr.send();
}
...
function f11() {
  ...
  xhr.onload = () => {
    ...
    console.log(receivedData);
    document.querySelector('.out-11').textContent = receivedData.password;
  }
  xhr.send(bodyData);
}
...
function f12() {
  ...
  let checkbox = +document.querySelector('.ch-12').checked;
...
function f13() {
  ...
  let checkboxSymbols = +document.querySelector('.ch-131').checked;
  let checkboxUppercase = +document.querySelector('.ch-132').checked;
...
function f14() {
  let select = document.querySelector('.s-14').value;

  let xhr = new XMLHttpRequest();
  xhr.open('GET', `${URL}/api/25/sr/read/${select}`);
  xhr.setRequestHeader('apikey', APIKEY);

  xhr.onload = () => {
    let receivedData = JSON.parse(xhr.response);
    document.querySelector('.out-14').innerHTML = receivedData.result.description;
  }
...
function f15() {
  ...
  xhr.onload = function () {
    ...
    receivedData.result.forEach(element => {
      let img = document.createElement('img');
...
function f16() {
  ...
  xhr.onload = () => {
    ...
    for (let item of receivedData.worlds) {
      out += `${item.title} `;
    }
...
function f17() {
  ...
  let xhr = new XMLHttpRequest();
  xhr.open('GET', `${URL}/api/25/gow/world/${select}`);
  xhr.setRequestHeader('apikey', APIKEY);

  xhr.onload = () => {
    let receivedData = JSON.parse(xhr.response);
    console.log(receivedData);
    document.querySelector('.out-17').textContent = receivedData.world.description;
  }
  xhr.send();
}
...
function f18() {
  ...
  xhr.onload = () => {
    out = '';
    let receivedData = JSON.parse(xhr.response);
    let imagesPathes = receivedData.rune;
    console.log(imagesPathes);

    for (let key in imagesPathes) {
      out += `<img src='${URL}${imagesPathes[key]}' alt='${key}'>`;
      /*  let img = document.createElement('img');
       img.src = `${URL}${imagesPathes[key]}`;
       img.alt = key;
       out.append(img); */
    }
