...
function f8() {
    ...
    // t.push(document.querySelector('.i-8').value);
...
function f11() {
    ...
    document.querySelector('.out-11').textContent = d11.indexOf(input);
}
...
function f18() {
    ...
    document.querySelector('.out-18').textContent = d18.includes(input);
}
...
let d19 = ['Your', 'payment', 'method', 'will', 'automatically', 'be', 'in', 'advance', 'every'];
let maxString = d19[0];
