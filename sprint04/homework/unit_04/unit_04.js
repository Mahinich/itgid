...
function f4() {
    ...
    // if (checkbox.checked) {
    //     document.querySelector('div.out-4').textContent = checkbox.checked;
    // } else {
    //     document.querySelector('div.out-4').textContent = checkbox.checked;
    // }
}
...
function f5() {
    ...
    if (checkbox.checked) {
        document.querySelector('div.out-5').textContent = checkbox.value;
    } else {
...
function f6() {
    document.querySelector('div.out-6').textContent = document.querySelector('input.i-6').value;
}
...
function f9() {
    const radioBtn = document.querySelector('.r-9');

    if (radioBtn.checked) {
        document.querySelector('.out-9').textContent = radioBtn.value;
    } else {
        document.querySelector('.out-9').textContent = radioBtn.checked;
    }
}
...
function f15() {
    document.querySelector('.t-15').textContent = document.querySelector('.i-15').value;
    document.querySelector('.out-15').textContent = document.querySelector('.i-15').value;
}
...
function f19() {
    document.querySelector('.i-19').value = document.querySelector('div.out-19').textContent;
}
