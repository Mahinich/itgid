...
function f2() {
   ...
   if (a21 > a22) {
      output.innerHTML = a21;
   }
   else {
      output.innerHTML = a22;
   }
}
...
function f6() {
   ...
   let output = document.querySelector('.out-6');
...
function f7() {
   ...
   document.querySelector('.out-7').innerHTML = Math.pow(input1, input2);
}
...
function f10() {
   let input = document.querySelector('.s-100').value;
   document.querySelector('.out-10').textContent = input;
}
...
function f14() {
   const input1 = +document.querySelector('.i-141').value;
   const input2 = +document.querySelector('.i-142').value;
...
function f15() {
   ...
   const operatorSelect = document.querySelector('.s-153').value;
   const output = document.querySelector('.out-15');

   // output.textContent = 0 && 1;

   if (operatorSelect == '&&') {
      output.textContent = select1 && select2;
   }
   else {
      output.textContent = select1 || select2;
   }
