...
function f5() {
    let out4HasClass = document.querySelector('.out-4').classList.contains('bg-orange');

    document.querySelector('.out-5').textContent = out4HasClass;
}
...
function f6() {
    ...
    document.querySelector('.out-6').textContent = paragraphs.length;
}
...
for (let i = 0; i < blocks10.length; i++) {
...
function f11() {
    ...
    let div = document.createElement('div').textContent = 25;
