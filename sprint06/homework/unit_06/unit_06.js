...
function t7() {
  ...
  document.querySelector('div.out-7').innerHTML = out;
}
...
function t8() {
  ...
  document.querySelector('div.out-8').innerHTML = out;
}
...
function t10() {
  ...
  document.querySelector('div.out-10').innerHTML = out;
}
