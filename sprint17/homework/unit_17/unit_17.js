...
function t6() {
    a6_res = a6.filter(item => {
        ...
        return typeof item === 'number' && item > 14;
    })
...
function t14() {
    return a14.includes(a14_sym.toLocaleLowerCase() || a14_sym.toUpperCase());
}
...
function t15() {
    a15_res = a15.filter((item, index, arr) => {
