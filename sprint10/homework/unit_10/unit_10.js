...
let ar4 = [1, 2, 3, 'a', 'b', 'c', 4, 5, 6, 'd', 'e', 'f'];
...
let ar5 = [13, 2, 33, 12, 87, 22, 89, 81, 9, 100];
...
function f16() {
    ...
    for (let i = 0; i < ar16.length; i++) {
        if (ar16[i] % 2 !== 0) {
            ar16_odd[oddIndex++] = ar16[i];
        } else {
            ar16_even[evenIndex++] = ar16[i];
        }
    }
